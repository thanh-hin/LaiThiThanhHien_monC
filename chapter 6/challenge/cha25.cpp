...
double inputValidate(double time) // 24 hr; 630am = 6.30; 930pm = 21.30;
{
    ...
    return time;//trả về giá trị time
}

//hàm xác thực đầu vào
double inputValidate(double number, int range)//định nghĩa hàm
{
...
void getHotelFees(int total_days_on_trip, double &total_expenses, 
...
void displayTotals(int total_days_on_trip,double departure_time,double arrival_time,double total_expenses,double total_allowable_expenses,double total_reimbursement,double total_amount_saved)
{
